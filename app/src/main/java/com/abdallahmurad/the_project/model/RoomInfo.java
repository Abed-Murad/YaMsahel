package com.abdallahmurad.the_project.model;
...
public class RoomInfo extends HotelRooms {
    ...
    private SlidingImageAdapter images;
    private boolean isRefundable;
    private boolean isWirelessFree;
    private boolean isParkingFree;


    public RoomInfo(int maxAdults, int adultsPerPrice, int priecPerAdult, String currancey, double earnMony, int numNights, int numRooms, SlidingImageAdapter images, boolean isRefundable, boolean isWirelessFree, boolean isParkingFree) {
    ...
    public SlidingImageAdapter getImages() {
        return images;
    }

    public void setImages(SlidingImageAdapter images) {
        this.images = images;
    }
