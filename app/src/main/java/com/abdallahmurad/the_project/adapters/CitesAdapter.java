...
import com.abdallahmurad.the_project.model.City;
import com.abdallahmurad.the_project.view.activites.HotelsPageActivity;
    ...
    public void onBindViewHolder(final CitesViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent hotelsIntent = new Intent(context, HotelsPageActivity.class);
