...
import com.abdallahmurad.the_project.adapters.view_holders.ProfileViewHolder;
...
public class ProfileAdapter extends RecyclerView.Adapter<ProfileViewHolder> {
    ...
    public final static int PROFILE_HEADER = 0;
    public final static int PROFILE_BALANCE = 1;
    public final static int PROFILE_FEATURE = 2;
