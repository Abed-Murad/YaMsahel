package com.abdallahmurad.the_project.adapters;
...
import com.abdallahmurad.the_project.model.Header;
import com.abdallahmurad.the_project.adapters.view_holders.HeaderViewHolder;
import com.abdallahmurad.the_project.model.RoomInfo;
import com.abdallahmurad.the_project.adapters.view_holders.RoomInfoViewHolder;
import com.abdallahmurad.the_project.model.Rooms;
import com.abdallahmurad.the_project.adapters.view_holders.RoomsViewHolder;
import com.abdallahmurad.the_project.model.UserDetails;
import com.abdallahmurad.the_project.view.activites.BookingDetailsActivity;
import com.abdallahmurad.the_project.R;
import com.abdallahmurad.the_project.adapters.view_holders.ParentViewHolder;
    ...
    public RoomsAdapter(final Context context, @NonNull List<Rooms> roomsList, Button bookNow) {
        ...
        bookNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.getContext().startActivity(new Intent(view.getContext(), BookingDetailsActivity.class));
            }
        });
    }
