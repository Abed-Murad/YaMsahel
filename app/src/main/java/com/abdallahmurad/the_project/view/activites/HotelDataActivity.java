...
import com.abdallahmurad.the_project.controller.SingeltonFirebase;
import com.abdallahmurad.the_project.model.Hotel;
import com.abdallahmurad.the_project.model.Rating;
import com.abdallahmurad.the_project.model.Review;
import com.abdallahmurad.the_project.adapters.SlidingImageAdapter;
...
import static com.abdallahmurad.the_project.controller.AppConstants.BAD;
import static com.abdallahmurad.the_project.controller.AppConstants.FAIR;
import static com.abdallahmurad.the_project.controller.AppConstants.GOOD;
import static com.abdallahmurad.the_project.controller.AppConstants.HOTEL_ID;
...
public class HotelDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hotelsImages.setAdapter(new SlidingImageAdapter(this, new ArrayList<>(Arrays.asList(R.drawable.room_image1, R.drawable.room_image2, R.drawable.room_image3, R.drawable.room_image4, R.drawable.room_image5))));
    ...
    private void initViews() {
        ...
        mDatabaseReference = SingeltonFirebase.getInstance().getReference();
    ...
    private void initListeners() {
        findViewById(R.id.selectRoomBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent bookingIntent = new Intent(HotelDataActivity.this, BookingActivity.class);
