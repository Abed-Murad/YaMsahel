...
public class SignInActivity extends CommBaseActivity implements View.OnClickListener {
...
//        }
    ...
    private void onAuthSuccess(FirebaseUser currentUser) {
        ...
        startActivity(new Intent(SignInActivity.this, MyIntroActivity.class));
        finish();
    }
