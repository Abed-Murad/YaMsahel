...
import com.abdallahmurad.the_project.adapters.HotelsListAdapter;
...
import static com.abdallahmurad.the_project.controller.AppConstants.CITY_ID;

public class HotelsPageActivity extends AppCompatActivity {
        ...
        mDatabaseReference.child("0/hotels").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (int i = 0; i < dataSnapshot.getChildrenCount(); i++) {
                    if (dataSnapshot.child(i + "").getValue(Hotel.class).getCityId() == cityId) {
...
//                0, R.drawable.ic_favorite_grey));
        ...
        filterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent filter = new Intent(HotelsPageActivity.this, FiltersActivity.class);
